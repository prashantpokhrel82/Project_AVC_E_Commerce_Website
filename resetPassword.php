...
include('./php/resetPasswordTest.php');
    ...
    <div class="col-sm-12 col-md-6 col-lg-6">
      <div class="jumbotron">
        ...
        if($id == 0){
          ...
          echo "<h3 align='center'>Already Changed the password.<br /><br />";
	  ...
	  <form ><!--action="<?php //echo $_SERVER['PHP_SELF'] ?>" method="POST">-->
		...
		<div class="form-group">
		  ...
		  <input type="password" class="form-control" required id="new_password" placeholder="Enter new password" name="new_password">

		</div>

    <div class="form-group">
		  <label for="pwd">New Confirm Password:</label>
		  <input type="password" class="form-control" required  id="new_confirm_password" placeholder="Enter new confirm password" name="new_confirm_password">

		</div>


		<a class="btn btn-info btn-block" onClick="resetPassword(<?php echo $id ?>)" id="change_password">Change Password</a>
	  </form>
